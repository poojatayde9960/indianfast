    ...
    if (isLoading) {
        return (
            <div className="p-4 sm:p-5 md:p-6 bg-[#F5F5F5] mt-20 min-h-[calc(100vh-80px)] overflow-y-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-12 mb-8">

                    {/* Stat Cards Skeleton */}
                    {[1, 2, 3].map((_, i) => (
                        <div
                            key={i}
                            className="bg-white rounded-3xl h-36 shadow-[0_4px_20px_0_rgba(0,0,0,0.1)] p-5 animate-pulse"
                        >
                            <div className="flex justify-between items-center mb-4">
                                <div className="h-5 w-28 bg-slate-300 rounded"></div>
                                <div className="h-11 w-11 bg-slate-300 rounded-full"></div>
                            </div>
                    ...
                    {/* Online/Offline Toggle Skeleton */}
                    <div className="w-full rounded-xl p-6 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.1)] animate-pulse">
                        <div className="h-5 w-40 bg-slate-300 rounded mb-3"></div>
                        <div className="h-4 w-56 bg-slate-300 rounded"></div>
                        <div className="mt-6 h-7 w-16 bg-slate-300 rounded-full"></div>
                    </div>

                    {/* Timer Card */}
                    <div className="bg-white w-full rounded-xl shadow-[0_4px_20px_rgba(0,0,0,0.1)] p-6 flex flex-col items-center animate-pulse">
                        <div className="h-10 w-40 bg-slate-300 rounded mb-3"></div>
                        <div className="h-5 w-32 bg-slate-300 rounded"></div>
                    </div>
                </div>

                {/* New Orders Skeleton */}
                <div className="bg-white rounded-xl p-6 shadow-[0_4px_20px_rgba(0,0,0,0.1)] animate-pulse">
                    <div className="h-6 w-48 bg-slate-300 rounded mb-5"></div>
